...
def filter_for_airchina(all_news):
    """只保留对国航有影响的新闻"""
    direct = ["国航","601111","航空","机票","民航","航班","机场","波音","空客","燃油","航油","旅游出行"]
    oil = ["原油","油价","OPEC","欧佩克","石油","制裁","伊朗","中东","波斯湾","以色列","霍尔木兹"]
    fx_trade = ["人民币","汇率","关税","中美","贸易战","出口","进口","WTO","制裁","谈判"]
    macro = ["央行","美联储","降息","加息","利率","CPI","通胀","GDP","PMI","LPR","政策","政治局","国常会"]
    market = ["A股","大盘","暴涨","暴跌","跌停潮","涨停潮","北向","万亿","放量","恐慌","新高","新低","3000","4000"]
    global_ = ["美股","纳指","道指","科技股","特斯拉","英伟达","苹果","微软","俄","乌克兰","朝鲜","韩国","日本","印度"]
